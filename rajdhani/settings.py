"""
Django settings for rajdhani project.
...
SECRET_KEY = 'django-insecure-%eneqrm13xn*^q5^y8jjmh!0s!*u8c-5upvr1llwp2ou9_7mb4'
...
MIDDLEWARE = [
    'core.middleware.UnicodeMiddleware',  # Add Unicode middleware first
...
WSGI_APPLICATION = 'rajdhani.wsgi.application'
...
# Add this for development - tells Django where to look for static files
STATICFILES_DIRS = [
    BASE_DIR / 'static',
